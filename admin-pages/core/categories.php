...
<body>
    ...
    <div class="side-nav" id="side-nav">
        ...
        <div class="sideNavMenu">
            ...
            <div class="sideNavButton">
                <div class="nav-icons"><a href="settings.html"><i class="fa-solid fa-gear"></i>
    ...
    <div class="adminContainer">
        ...
        <div class="noItemContainer">
            <?php
            $sqlCart = "SELECT * FROM categories";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="border: 1px solid black; padding: 5px;">
                                        <img src="../../user-pages/main_img/<?= $fetchCart['image'] ?>" height="70" width="100">
                                    </td>
                                    <td style="border: 1px solid black; padding: 5px;"><?= $fetchCart["link"]; ?></td>
...
'<?php echo $fetchCart['category_name']; ?>',
'<?php echo $fetchCart['is_active']; ?>',
'<?php echo $fetchCart['image']; ?>'
                                            ...
                                            <!-- <a class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" onclick="return confirm('Are you sure you want to delete <?= $fetchCart['category_name']; ?>?');" href="../action/drop-category.php?id=<?= $fetchCart['id']; ?>">
...
-->
    ...
    <div class="modal fade" id="modal-default-fadein2" role="dialog" aria-labelledby="modal-default-fadein2" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <form id="app_frm3" action="../action/update-category.php" method="POST" enctype="multipart/form-data" autocomplete="off">
    ...
    <div class="modal-body pb-1">
        <div class="row mb-2">
            ...
            <div class="col-sm-8">
                <input id="category_name" name="category_name" required type="text" class="form-control form-control-alt" placeholder="Enter category name">
            </div>
        </div>
        <div class="row mb-2">
            <label class="col-sm-4 col-form-label">Image</label>
            <div class="col-sm-8">
                <input id="img" name="image" required type="file" class="form-control form-control-alt" onchange="previewImage(event)">
    ...
    <div class="modal fade" id="modal-add" role="dialog" aria-labelledby="modal-default-fadein2" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
            <form id="app_frm3" action="../action/add-category.php" method="POST" enctype="multipart/form-data" autocomplete="off">
    <div class="modal-header">
...
<script>
    function set_user(id, catname, status, image) {
