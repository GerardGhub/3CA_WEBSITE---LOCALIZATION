                ...
                <div style="position: absolute; top: 15%; left: 0; width: 80%; margin-left: 10%; margin-right: 10%">
                    <table id="example" class="table table-striped table-hover" style="width: 100%; text-align:center">
                        ...
                        <tbody>
                            ...
                            FROM tocart_db CART 
                            INNER JOIN form_db FORM ON CART.userid=FORM.id
                            WHERE CART.order_movement_status ='PENDING'";
                            $queryCart = mysqli_query($conn, $sqlCart);
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="border: 1px solid black; padding: 5px;"><?= $fetchCart["message"]; ?></td>
...
'<?php echo $fetchCart['price']; ?>',
                                            ...
                                            <button onclick="set_user_no_img('<?php echo $fetchCart['id']; ?>',
        '<?php echo $fetchCart['firstname']; ?>',
        '<?php echo $fetchCart['message']; ?>',
        '<?php echo $fetchCart['price']; ?>',
        '<?php echo $fetchCart['address']; ?>',
        '<?php echo $fetchCart['contactNumber']; ?>',);" type="button" class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" data-bs-toggle="modal" data-bs-target="#modal-sending" data-bs-keyboard="false" data-bs-backdrop="static">
...
-->
    ...
    <div class="modal fade" id="modal-default-fadein2" role="dialog" aria-labelledby="modal-default-fadein2" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 1000px;">
                <form id="app_frm3" action="../action/update-pending-orders.php" method="POST" autocomplete="off">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-8">
                                <select id="movementstatus" name="order_movement_status" required class="form-control form-control-alt">
                                    ...
                                    <option style="display: none;" id="optReceived" value="RECEIVED">RECEIVED</option>
                                </select>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="modal-sending" role="dialog" aria-labelledby="modal-default-fadein2" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 1000px;">
                <form id="app_frm5" action="../action/update-customer-notip.php" method="POST" autocomplete="off">
                    <div class="modal-header">
                        <h5 class="modal-title">Customer Notifyer</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body pb-1">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-8">
                                <textarea id="message2" name="message" required rows="15" class="form-control form-control-alt">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-alt-secondary" data-bs-dismiss="modal">Close</button>
                        <button style="display: none;" id="sub_btn5" type="submit" class="btn  btn-primary">Send</button>
...
<script>
    function set_user(id, fname, contactno, dateorder, status,
        address, productname, ordermovementstatus, price) {
        ...
        document.getElementById('movementstatus').value = ordermovementstatus;
            ...
            document.getElementById('optReceived').style.display = 'block';
        
    }



    function set_user_no_img(id, fname, message, price, address, contactno) {
        ...
        if (message === '') {
            ...
            document.getElementById('sub_btn5').style.display = 'block';


            var messageContent = "Hello ma'am/sir " + fname + ", we are now preparing your order/s. Please prepare an amount of " + price +
                " as your delivery fee. Rest assured we will deliver your item right on your address " + address +
                ".You will received a message on your " + contactno + " once your order is on its way to your address. Thank you for ordering! ";
            document.getElementById('message2').value = messageContent;

        } else {


          
            document.getElementById('sub_btn3').style.display = 'block';
            document.getElementById('optReceived').style.display = 'block';
