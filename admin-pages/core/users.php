                ...
                <div style="position: absolute; top: 15%; left: 0; width: 80%; margin-left: 10%; margin-right: 10%">
                    <table id="example" class="table table-striped table-hover" style="width: 100%; text-align:center">
                        ...
                        <tbody>
                            ...
                            $sqlCart = "SELECT * FROM form_db where not userType='admin'";
                            $queryCart = mysqli_query($conn, $sqlCart);
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="border: 1px solid black; padding: 5px;"><?= $fetchCart["firstname"]; ?></td>
                                    <td style="border: 1px solid black; padding: 5px;"><?= $fetchCart["middlename"]; ?></td>
                                    <td style="border: 1px solid black; padding: 5px;"><?= $fetchCart["lastname"]; ?></td>
                                    ...
                                    <td style="border: 1px solid black; padding: 5px;"><?= $fetchCart["sex"]; ?></td>
                                    <td style="border: 1px solid black; padding: 5px;"><?= $fetchCart["userType"]; ?></td>
                                    ...
                                    <td style="border: 1px solid black; padding: 5px;" class="text-center">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            '<?php echo $fetchCart['middlename']; ?>',
                                            '<?php echo $fetchCart['lastname']; ?>',
                                            '<?php echo $fetchCart['username']; ?>',
                                            '<?php echo $fetchCart['sex']; ?>',
                                            '<?php echo $fetchCart['contactNumber']; ?>',
                                            '<?php echo $fetchCart['IsActive']; ?>',
                                            '<?php echo $fetchCart['address']; ?>',
                                            '<?php echo $fetchCart['userType']; ?>',
                                            ...
                                            <a class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" onclick="return confirm('Are you sure you want to delete <?= $fetchCart['firstname']; ?>?');" href="../action/drop-user.php?id=<?= $fetchCart['id']; ?>">
...
<script>
    function set_user(id, fname, mname, lname, email, gender, contactNumber, status, address, role) {
