...
<head>
    ...
    <!-- ceiling shop css -->
    <link rel="stylesheet" href="ceiling.css">
</head>
<body>
    ...
    <div class="page-info">
      ...
      <p class="separate"> | </p>
      <a href="ceiling.html" class="current-page">Ceilings</a>
    </div>

    <div class="page-title">
      <h1 class="categoryName">CEILINGS</h1>
      <p class="phrase">Brows ceiling needs of your choice here!</p>
    </div>
