...
?>
    ...
    <body>
        ...
        <div class="noItemContainer">
            ...
            <?php
            $sqlCart = "SELECT * FROM tocart_db WHERE reference='' AND userid={$_SESSION["userEmpID"]} AND is_active = 1";
                ...
                <div style="position: absolute; top: 15%; left: 0; width: 80%; margin-left: 10%; margin-right: 10%">
                    ...
                    <table style="width: 100%">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="border: 1px solid black; padding: 5px; text-align: center">
                                        ...
                                        <a class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" onclick="return confirm('Are you sure you want to remove the <?= $fetchCart['productName']; ?> from your cart?');" href="../action/drop-cart.php?id=<?= $fetchCart['id']; ?>">
                        ...
                        <tfoot>
                            ...
                            <th colspan="4" style="border: 1px solid black; padding: 5px; text-align: left">&#8369; <?= number_format($sum, 2); ?></th>
                        </tfoot>
                    </table>
                    <button type="button" id="btnContinueShopping" style="padding: 10px; margin-top: 10px; border-radius: 10px; border: 1px solid #0275d8; background-color: #0275d8; color: white; font-weight: bolder; cursor: pointer">CONTINUE SHOPPING</button>
                    <button type="button" id="btnCheckout" style="padding: 10px; margin-top: 10px; border-radius: 10px; border: 1px solid #5cb85c; background-color: #5cb85c; color: white; font-weight: bolder; cursor: pointer">CHECKOUT</button>
                </div>
            <?php
            } else {
            ?>
                <div class="noItem">
                    ...
                    <a href="../../index.php" class="toShop">Continue to shop</a>
                </div>
            <?php
            }
            ?>
        ...
        <script>
            $(function() {
                $("#btnCheckout").on("click", function() {
                    if (confirm("Are you sure do you want to checkout?")) {
                        $.ajax({
                            url: "../ajax/ajax-checkout.php",
                            success: function(d) {
                                alert("You have successfully checked out your order. Thank you");
